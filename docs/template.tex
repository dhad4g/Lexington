...
\begin{center}
    ...
    $endif$
    \vspace{5cm}
    \textbf{\LARGE GPro1 Lexington}\\[\baselineskip] % Main title
    $if(subtitle)$
        {\LARGE \textit{$subtitle$}} \\ % Subtitle
    $endif$
    \vspace{3cm}
    $if(author)$
        {\large Authors:} \\
    ...
    $endif$
    \vfill
    This document is a part of an open source project which is freely available
    for private and comercial use under the GPLv3 license. For additional information
    or better rendering of large tables, refer to
    \href{https://github.com/GProCpu/Lexington}{https://github.com/GProCpu/Lexington}.
    \\ \vspace{0.5cm}
    Copyright (C) \the\year{}  $institute$ \\
    \vspace{1cm}
    \today
\end{center}
\clearpage
