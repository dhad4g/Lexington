...
set vars(power_analysis_view)   view_fast
...
# set vars(cpus_per_remote_host)  2
set vars(disbribute)            local
set vars(local_cpus)            8
# set vars(distribute)            rsh
# set vars(distribute_timeout)    5
# set vars(remote_hosts)          18
# set vars(local_cpus)            8
# set vars(cpus_per_remote_host)  8
# set vars(rsh,host_list)  "\
#     el103-01.ece.usu.edu\
#     el103-02.ece.usu.edu\
#     el103-03.ece.usu.edu\
#     el103-04.ece.usu.edu\
#     el103-05.ece.usu.edu\
#     el103-06.ece.usu.edu\
#     el103-07.ece.usu.edu\
#     el103-09.ece.usu.edu\
#     el103-10.ece.usu.edu\
#     el103-11.ece.usu.edu\
#     el103-12.ece.usu.edu\
#     el103-13.ece.usu.edu\
